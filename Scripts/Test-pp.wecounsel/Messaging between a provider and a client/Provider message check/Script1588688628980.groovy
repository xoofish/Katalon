...
'Gets text of client reply'
def text = WebUI.getText(findTestObject('Page_WeCounsel/Moby Dick Test Response'))

'Checks if gathered text matches expected text'
if (text.contains('Moby Dick Test Response')) {
} else {
