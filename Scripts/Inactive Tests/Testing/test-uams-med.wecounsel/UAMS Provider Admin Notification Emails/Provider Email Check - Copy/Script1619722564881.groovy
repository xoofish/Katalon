...
WebUI.setText(findTestObject('input_to continue to Gmail_identifier'), 'alexuamsqa@gmail.com')

WebUI.click(findTestObject('div_gmail user next'))
...
'Checks provider mailbox for most recent email'
...
if (emailCont.contains('Hello UAMS - Provider Auto Test')) {
} else if (emailCont.contains('Hello UAMS Manager Auto Test')) {
} else {
