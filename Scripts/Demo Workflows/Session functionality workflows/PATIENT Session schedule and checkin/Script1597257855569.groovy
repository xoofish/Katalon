...
WebUI.enhancedClick(findTestObject('Demo Workflows/Org admin checkin as patient/Finish finish button'))

WebUI.delay(10)

WebUI.click(findTestObject('Demo Workflows/Session functionality/Session schedule and checkin/Filters button'))

'filter by autoclient'
